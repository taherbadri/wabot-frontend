...
import {
	...
	fetchMaterialOrServiceListStatuses,
} from '@/lib/features/donation/donationManagementSlice';
import { Table } from '@/components/ui/table';

export default function MaterialisticTable() {
	...
	const { materialisticList: data } = useAppSelector(
		(store) => store.donationManagement
	);

	useEffect(() => {
		dispatch(fetchMaterialisticList());
		dispatch(fetchMaterialOrServiceListStatuses('material_item'));
	}, [dispatch]);
